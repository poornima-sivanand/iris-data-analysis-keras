...
```
    ...
    <ipython-input-38-2aa57a1383be> in <module>
    ----> 1 plot_model(model, to_file='model_plot.png', show_shapes=True, show_layer_names=True)
    

    ~/opt/anaconda3/envs/iris/lib/python3.6/site-packages/keras/utils/vis_utils.py in plot_model(model, to_file, show_shapes, show_layer_names, rankdir, expand_nested, dpi)
        238     """
    ...
    ~/opt/anaconda3/envs/iris/lib/python3.6/site-packages/keras/utils/vis_utils.py in model_to_dot(model, show_shapes, show_layer_names, rankdir, expand_nested, dpi, subgraph)
    ...
    ~/opt/anaconda3/envs/iris/lib/python3.6/site-packages/keras/utils/vis_utils.py in _check_pydot()
         20     if pydot is None:
